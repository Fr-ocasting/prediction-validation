...
def load_data(FOLDER_PATH, invalid_dates, coverage_period, args, normalize=True,
    ...
    try:
        ...
        return None
    raise NotImplementedError("Il faut probablement aggréger des stations (qui se trouve au mêmes endroits par exemple, faire des sommes\
                              pour avoir un proxy de déplacement, plutôt que les gardée brute car bien trop sparse, et ne représentent rien")
