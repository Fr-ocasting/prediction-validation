...
from pipeline.Evaluation.STDA2.clustering.clustering import filter_by_temporal_agg
...
def get_inflow_outflow(df_raw_in_no_agg,df_raw_out_no_agg,filter_q=None,city=None,period='all_day',day_type = None,index_name= 'idstation'):
