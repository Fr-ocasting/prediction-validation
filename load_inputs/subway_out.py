...
def load_data(FOLDER_PATH,invalid_dates,coverage_period,args,normalize):
    ...
    preprocessed_personal_input = load_input_and_preprocess(dims = dims,normalize=normalize,invalid_dates=invalid_dates,args=args,data_T=T_subway_out,coverage_period=coverage_period,name=NAME)
