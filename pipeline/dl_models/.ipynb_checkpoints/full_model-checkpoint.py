...
from pipeline.dl_models.vision_models.simple_feature_extractor import FeatureExtractor_ResNetInspired,MinimalFeatureExtractor,ImageAvgPooling,FeatureExtractor_ResNetInspired_bis
from pipeline.dl_models.vision_models.AttentionFeatureExtractor import AttentionFeatureExtractor
from pipeline.dl_models.vision_models.FeatureExtractorEncoderDecoder import FeatureExtractorEncoderDecoder
from pipeline.dl_models.vision_models.VideoFeatureExtractorWithSpatialTemporalAttention import VideoFeatureExtractorWithSpatialTemporalAttention
...
def load_model(dataset, args):
    ...
    if args.model_name == 'LSTM':
        from pipeline.dl_models.LSTM.load_config import args as LSTM_args
        model = RNN(**vars(LSTM_args),out_dim =args.out_dim,L=args.L,dropout=args.dropout).to(args.device)
                          
    if args.model_name == 'GRU':
        from pipeline.dl_models.GRU.load_config import args as GRU_args
        model = RNN(**vars(GRU_args),out_dim =args.out_dim,L=args.L, dropout=args.dropout).to(args.device)
   
    if args.model_name == 'RNN':
        from pipeline.dl_models.RNN.load_config import args as RNN_args
