...
parser.add_argument('--C_outs', type=int, nargs='+', default=[16], choices = [[16],[32], [16, 8]], help="Output dimensions for convolution layers")
...
parser.add_argument('--lstm', type=bool, default=True, help="Enable lstm mode for rnn")
