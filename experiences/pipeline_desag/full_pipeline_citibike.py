...
possible_target_kwargs[target_data]['threshold_volume_min'] = THRESHOLD_VOLUME_MIN  # number_of_month_in_period

config_backbone_model = model_configurations[model_name]
config_backbone_model['H'] = 6
config_backbone_model['D'] = 1
config_backbone_model['W'] = 0
config_backbone_model['train_prop'] = 0.8
config_backbone_model['valid_prop'] = 0.1
config_backbone_model['standardize'] = True
config_backbone_model['minmaxnorm'] = False
config_backbone_model['batch_size'] = 32 # # 32
config_backbone_model['epochs'] = 50 #5
...
for contextual_dataset_names in possible_contextual_dataset_names:
    ...
    config_backbone_model = model_configurations[model_name]
    config_backbone_model['batch_size'] = 32 # 150 #80
    config_backbone_model['epochs'] = 50
