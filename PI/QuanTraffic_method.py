...
if __name__ == '__main__': 
    ...
    (loss_function,Model_list,Optimizer_list,Scheduler_list,args_embedding) = get_MultiModel_loss_args_emb_opts(args,nb_words_embedding,dic_class2rpz,num_nodes = len(Datasets[0].spatial_unit))
