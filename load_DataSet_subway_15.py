...
def load_normalized_dataset(df,time_step_per_hour,train_prop,step_ahead,H,D,W,invalid_dates=[]):
    ...
    dataset = dataset.normalize_df(train_prop,invalid_dates)
...
if __name__ == '__main__':
    ...
    (dataset_out,U_out,Utarget_out) = load_normalized_dataset(subway_out,time_step_per_hour,train_prop,invalid_dates)
