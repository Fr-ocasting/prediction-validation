...
if __name__ == '__main__':
    ...
    for dataset_names,vision_model_name in zip([['netmob_POIs','calendar']],['VariableSelectionNetwork']): # zip([['subway_in','netmob_POIs','calendar'],['subway_in']],['VariableSelectionNetwork',None]):
        # GET PARAMETERS
