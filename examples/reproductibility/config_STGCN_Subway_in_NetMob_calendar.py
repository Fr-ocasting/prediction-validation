...
# # 1 YEAR DATA [Bike_in, Bike_out]   STACK CHANNEL
# # All Steps RMSE = 50.76, MAE = 25.60, MAPE = 24.44, MSE = 2593.41
...
# # 1 YEAR DATA [ Bike_out]   STACK CHANNEL
# # All Steps RMSE = 50.67, MAE = 25.50, MAPE = 23.46, MSE = 2585.51
...
# # 1 YEAR DATA [Bike_in ]  STACK CHANNEL
# # All Steps RMSE = 50.78, MAE = 25.56, MAPE = 24.26, MSE = 2593.65
...
# # 1 YEAR DATA [Bike_in, Bike_out]   CONCATENATION LATE
...
# # 1 YEAR DATA [ Bike_out]    CONCATENATION LATE
...
# # 1 YEAR DATA [Bike_in ]    CONCATENATION LATE
