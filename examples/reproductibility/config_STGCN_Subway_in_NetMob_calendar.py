...
# All Steps RMSE = 39.11, MAE = 21.96, MAPE = 25.52, MSE = 1531.86    # si 'L_out': 1, num_heads = 2, dim_model = 24,dim_feedforward = 64, latent dim = 32 
# All Steps RMSE = 38.63, MAE = 21.56, MAPE = 25.00, MSE = 1494.36   # si 'L_out': 1, num_heads = 2, dim_model = 24,dim_feedforward = 64, latent dim = 64 
# All Steps RMSE = 38.96, MAE = 21.82, MAPE = 25.76, MSE = 1520.43  # si 'L_out': 1, num_heads = 4, dim_model = 48, dim_feedforward = 64, latent dim = 64
# All Steps RMSE = 39.27, MAE = 21.98, MAPE = 25.02, MSE = 1544.54   # si 'L_out': 1, num_heads = 2, dim_model = 24,dim_feedforward = 128, latent dim = 64 
#  All Steps RMSE = 39.25, MAE = 21.88, MAPE = 25.59, MSE = 1542.60  # si 'L_out': 8, num_heads = 2, dim_model = 24,dim_feedforward = 64, latent dim = 8
'subway_in_calendar_subway_OUT_emb64_out64_Huber_MinMax_Attn_lout1_h2_d24_ff64_l64': {'target_data': 'subway_in',
...
'subway_in_calendar_subway_OUT_emb64_out64_Huber_MinMax_Attn_lout1_h2_d24_ff64_l128': {'target_data': 'subway_in',
                                                  'dataset_names': ['subway_in', 'calendar_embedding','subway_out'],
                                                  'dataset_for_coverage': ['subway_in','netmob_POIs'],
                                                  'embedding_calendar_types': ['dayofweek', 'hour'],
                                                  'loss_function_type':'HuberLoss',
...
'subway_in_calendar_subway_OUT_emb64_out64_Huber_MinMax_Attn_lout2_h2_d24_ff64_l64': {'target_data': 'subway_in',
                                                  'dataset_names': ['subway_in', 'calendar_embedding','subway_out'],
                                                  'dataset_for_coverage': ['subway_in','netmob_POIs'],
                                                  'embedding_calendar_types': ['dayofweek', 'hour'],
                                                  'loss_function_type':'HuberLoss',
...
'subway_in_calendar_subway_OUT_emb64_out64_Huber_MinMax_Attn_lout2_h2_d24_ff64_l128': {'target_data': 'subway_in',
                                                  'dataset_names': ['subway_in', 'calendar_embedding','subway_out'],
                                                  'dataset_for_coverage': ['subway_in','netmob_POIs'],
                                                  'embedding_calendar_types': ['dayofweek', 'hour'],
                                                  'loss_function_type':'HuberLoss',
...
'subway_in_calendar_subway_OUT_emb64_out64_Huber_MinMax_Attn_lout2_h4_d64_ff64_l128': {'target_data': 'subway_in',
                                                  'dataset_names': ['subway_in', 'calendar_embedding','subway_out'],
                                                  'dataset_for_coverage': ['subway_in','netmob_POIs'],
                                                  'embedding_calendar_types': ['dayofweek', 'hour'],
                                                  'loss_function_type':'HuberLoss',
...
'subway_in_calendar_subway_OUT_emb64_out64_Huber_MinMax_Attn_lout2_h4_d64_ff64_l64': {'target_data': 'subway_in',
                                                  'dataset_names': ['subway_in', 'calendar_embedding','subway_out'],
                                                  'dataset_for_coverage': ['subway_in','netmob_POIs'],
                                                  'embedding_calendar_types': ['dayofweek', 'hour'],
                                                  'loss_function_type':'HuberLoss',
...
'subway_in_calendar_subway_OUT_emb64_out64_Huber_MinMax_Attn_lout1_h4_d64_ff64_l64': {'target_data': 'subway_in',
                                                  'dataset_names': ['subway_in', 'calendar_embedding','subway_out'],
                                                  'dataset_for_coverage': ['subway_in','netmob_POIs'],
                                                  'embedding_calendar_types': ['dayofweek', 'hour'],
                                                  'loss_function_type':'HuberLoss',
...
# 'subway_in_calendar_subway_OUT_emb64_out64_Huber_MinMax': {'target_data': 'subway_in',
#                                                   'dataset_names': ['subway_in', 'calendar_embedding','subway_out'],
#                                                   'dataset_for_coverage': ['subway_in','netmob_POIs'],
#                                                   'embedding_calendar_types': ['dayofweek', 'hour'],
#                                                   'loss_function_type':'HuberLoss',
