...
constant_name = 'adapt_64_emb_dim_24_ff256_h4l3_Huberloss_500e'
constant_modif = {'loss_function_type':'HuberLoss',
                        'optimizer': 'adamw',
                        'batch_size': 128,
                        'epochs':500,
...
modifications = {
                ...
                #                                 },
                    ...
                    'baseline_300E': {'dataset_names': ['subway_in','calendar'],
                                'loss_function_type':'MSE',
                                    'lr': 1e-3, # 5e-5,# 4e-4,
                ...
                'baseline_300E_HuberLoss': {'dataset_names': ['subway_in','calendar'],
                                'loss_function_type':'HuberLoss',
                                    'lr': 1e-3, # 5e-5,# 4e-4,
                                    'weight_decay': 0.066, # 0.05,
                                    'dropout': 0.15, # 0.15,
                ...
                'baseline_300E_HuberLoss_standardize': {'dataset_names': ['subway_in','calendar'],
                                'loss_function_type':'HuberLoss',
                                    'lr': 1e-3, # 5e-5,# 4e-4,
                                    'weight_decay': 0.066, # 0.05,
                                    'dropout': 0.15, # 0.15,
