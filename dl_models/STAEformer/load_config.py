...
parser.add_argument('--input_embedding_dim', type=str, default=8, help='Size of the embedding space for input features')
...
parser.add_argument('--adaptive_embedding_dim', type=str, default=32, help='Size of the adaptive spatial embedding; set to 0 to disable')
parser.add_argument('--num_heads', type=str, default=2, help='Number of multi-head attention heads')
parser.add_argument('--num_layers', type=str, default=4, help='Number of MLP layers after attention')
parser.add_argument('--feed_forward_dim', type=str, default=16, help='Size of the feed forward layer after each attention layer (spatial and temporal) ')
