...
def normalize_adj_mx(adj_mx,adj_normalize_method):
    """load normalized adjacency matrix.

    Args:
        adj_mx (np.array): adjacency matrix
        adj_normalize_method (str): type of method to normalize the adjacency matrix.
