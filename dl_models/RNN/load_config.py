...
parser.add_argument('--C_outs', type=int, nargs='+', default=[16],choices = [[16],[32], [16, 8]], help="Dimensions of the output layers (sequential FC layers)")
parser.add_argument('--num_layers', type=int, default=2, help="Number of layers")
parser.add_argument('--bias', type=bool, default=True, choices = [True, False], help="Use bias in layers")
parser.add_argument('--bidirectional', type=bool, default=True, choices = [True, False], help="Enable bidirectional mode")
